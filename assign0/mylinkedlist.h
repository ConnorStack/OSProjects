 ...
 * --------------------------
 * This function allocates space for a student cell and intilize its fields
 */
...
void repeatStudentEntryError();

student_cell_T *getStudentById(linked_list_T *list, int studentId);
